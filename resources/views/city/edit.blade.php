...
<div class="content-wrapper pb-4">
    ...
    <section class="content">
        <form method="post" action="{{url('/admin/storeEditCity/'.$singleCity->id)}}" class="w-75 m-auto">
            @csrf
            @method('PUT')
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input autofocus required minlength="4" maxlength="100" type="text" id="name" value="{{$singleCity->name}}"
